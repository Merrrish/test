...
import UserInfo from '@/components/properties/UserInfo'; // Ensure this is imported
...
async function PropertyDetailsPage({ params }: { params: { id: string } }) {
  ...
  const { breakfast, privateroom, beds, guests } = property;
  const details = { breakfast, privateroom, beds, guests };
    ...
    <section>
      ...
      <section className='lg:grid lg:grid-cols-12 gap-x-12 mt-12'>
        <div className='lg:col-span-8'>
          ...
          {/* Render UserInfo with just the host's image and name */}
        ...
        <div className='lg:col-span-4 flex flex-col items-center'>
          ...
          />
          {/* Add Estimated Time of Arrival input */}
          <div className='mt-8'>

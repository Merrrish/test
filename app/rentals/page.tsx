import { useUser } from '@clerk/nextjs'; // to check user roles
...
async function RentalsPage() {
  ...
  const isAdmin = Array.isArray(user?.publicMetadata?.roles) && user?.publicMetadata.roles.includes('admin');
            ...
            return (
              <TableRow key={propertyId}>
                ...
                <TableCell className="flex items-center gap-x-2">
                  ...
                  {isAdmin && <DeleteRental propertyId={propertyId} />} {/* Only show delete button for admin */}
                </TableCell>
              </TableRow>
            );
          })}
